...
const SHARED_ADMIN_ITEMS: NavItem[] = [
  { href: "/admin/clausulas", label: "Cláusulas ISO", icon: BookOpen },
  ...
  return (
    <aside className="flex flex-col w-64 min-h-screen bg-slate-900 text-slate-100 border-r border-slate-800">
      ...
      <nav className="flex-1 px-3 py-4 space-y-1 overflow-y-auto">
        ...
        <NavSection items={SHARED_ADMIN_ITEMS} pathname={pathname} />
        {isAdmin && <NavSection items={ADMIN_NAV_ITEMS} pathname={pathname} />}
      </nav>
